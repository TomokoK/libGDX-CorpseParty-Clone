...
public class SecondFloorStairCase2Screen extends AbstractScreen {
    ...
    public SecondFloorStairCase2Screen(Seven startClass) {
        super(startClass);
    ...
    public void show() {
        ...
        // set our map
        map = new TmxMapLoader().load("maps/SecondFloorStairCase2.tmx");
        // render map
