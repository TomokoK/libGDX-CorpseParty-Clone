...
public class SecondFloorStairCaseScreen extends AbstractScreen {
    ...
    public SecondFloorStairCaseScreen(Seven startClass) {
        super(startClass);
...
//        camera.update();
    ...
    public void show() {
        ...
        // set our map
        map = new TmxMapLoader().load("maps/SecondFloorStairCase.tmx");
        // render map
